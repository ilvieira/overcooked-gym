...
from environment.overcooked import Overcooked, HOLDING_ONION, HOLDING_NOTHING, HOLDING_DISH, ACTION_MEANINGS
    ...
    def policy(self, state: ndarray):
        ...
        if hand == HOLDING_NOTHING:
            ...
            # this would be the case in which the agent has the soup. It should never happen
                ...
                if self._facing_empty_balcony(state) or self._facing_delivery_window(state):
                    action = ACTION_MEANINGS.index("act")
